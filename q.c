...
void go(void){
    ...
    while (val == true){
        ...
        cents_01 = getchar();                                                                   //recives second value after "." as char
        if (cents_01 == 10){break;}                                                             //stop if there is no input for second value after "." (integer 10 represents "\n" based on ascii table)(so the program ends when it detects a newline which is ("\n"))
        ...
        //if (cents_10 != 10 && cents_01 != 10 && e_cents != 10){val = false; break;}             //stop if there is no input for third value after "." (integer 10 represents "\n" based on ascii table)(so the program ends when it detects a newline which is ("\n"))
                        //e_cents is causing issus when taking input values from loop-input.txt file
    ...
    //else{printf("You did not type in the correct format in terms of dollars and cents.\n");}      //default statement to print when leving loop due to input not being inputted in the correct form
                        //the below is in a single line form of the 2 above
    max_limit == true ? printf("amount entered is too large please try again later\n") : printf("You did not type in the correct format in terms of dollars and cents.\n");
}
/*workking test cases:
=============================================================================================================================================================================================================================
| no.:  |  test cases:  |  program status:            |  program output:                                                                    |   reasons for output based on test cases:                                     |
=============================================================================================================================================================================================================================
| 1     |  .00          |  program ends [works]       |  prints "You did not type in the correct format in terms of dollars and cents.\n"   |   breaks the loop due to amount entered does not have dollars value           |
| 2     |  0.           |  program ends [works]       |  prints "You did not type in the correct format in terms of dollars and cents.\n"   |   breaks the loop due to amount entered does not have cents_10 value          |
| 3     |  0.0          |  program ends [works]       |  prints "You did not type in the correct format in terms of dollars and cents.\n"   |   breaks the loop due to amount entered does not have cents_01 value          |
| 4     |  1            |  program ends [works]       |  prints "You did not type in the correct format in terms of dollars and cents.\n"   |   breaks the loop due to amount entered only have dollars value               |
| 5     |  -1           |  program ends [works]       |  prints "You did not type in the correct format in terms of dollars and cents.\n"   |   breaks the loop due to amount entered is of negative value                  |
| 6     |  -1.          |  program ends [works]       |  prints "You did not type in the correct format in terms of dollars and cents.\n"   |   breaks the loop due to amount entered is of negative value                  |
| 7     |  -1.0         |  program ends [works]       |  prints "You did not type in the correct format in terms of dollars and cents.\n"   |   breaks the loop due to amount entered is of negative value                  |
| 8     |  -1.00        |  program ends [works]       |  prints "You did not type in the correct format in terms of dollars and cents.\n"   |   breaks the loop due to amount entered is of negative value                  |
| 9     |  0.-10        |  program ends [works]       |  prints "You did not type in the correct format in terms of dollars and cents.\n"   |   breaks the loop due to amount entered is of negative value                  |
| 10    |  0.0-1        |  program ends [works]       |  prints "You did not type in the correct format in terms of dollars and cents.\n"   |   breaks the loop due to amount entered is of negative value                  |
| 11    |  1.000        |  program ends [ISSUE](ONLY WHEN CHECKING WITH DIFF)|  prints "You did not type in the correct format in terms of dollars and cents.\n"   |   breaks the loop due to amount entered has third value after decimal place   |
| 12    |  1.0000       |  program ends [ISSUE](ONLY WHEN CHECKING WITH DIFF)|  prints "You did not type in the correct format in terms of dollars and cents.\n"   |   breaks the loop due to amount entered has third value after decimal place   |
| 13    |  1.00000      |  program ends [ISSUE](ONLY WHEN CHECKING WITH DIFF)|  prints "You did not type in the correct format in terms of dollars and cents.\n"   |   breaks the loop due to amount entered has third value after decimal place   |
| 14    |  21474836.99  |  program ends [works]       |  prints "amount entered is too large please try again later\n"                      |   breaks the loop due to amount entered is too large                          |
|       |                                             |                                                                                     |                                                                               |
| 15    |  0.00         |  program continues [works]  |  goes through the loop again                                                        |                                                                               |
| 16    |  1.23         |  program continues [works]  |  goes through the loop again                                                        |                                                                               |
| 17    |  12.23        |  program continues [works]  |  goes through the loop again                                                        |                                                                               |
| 18    |  123.45       |  program continues [works]  |  goes through the loop again                                                        |                                                                               |
| 19    |  21474835.99  |  program continues [works]  |  goes through the loop again                                                        |   {larges number the program can works with if the number is more then        |
|       |               |                             |                                                                                     |   21474835.99 the loop will break as can be see from no. 14}                  |
=============================================================================================================================================================================================================================
*/
